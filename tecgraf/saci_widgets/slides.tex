...
\begin{frame}{Widgets Qt}
  Widgets editáveis que refletem um modelo
  \begin{itemize}
  \item<1->Valor inicial do modelo é definido no widget.
  \item<2->Alteração do valor modelo <-> visão
  \end{itemize}
\end{frame}
